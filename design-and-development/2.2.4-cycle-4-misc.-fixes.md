...
I decided to keep the parameters for generation the same. This is because I decided it would make more sense to adjust them after I had built the car object so that it would be fit for purpose.

It was hard to measure the performance of either the newer algorithm or the older algorithm. This meant that I wasn't sure whether my changes would increase or decrease both the spacial and temporal efficiency of the program.
