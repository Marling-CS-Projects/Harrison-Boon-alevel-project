...
![Ball before bouncing, above the plane](../.gitbook/assets/image.png)

![Ball after bouncing off of the plane](<../.gitbook/assets/image (9).png>)

![The ball from a different camera angle after having teleported to the top after falling too far](<../.gitbook/assets/image (8).png>)
