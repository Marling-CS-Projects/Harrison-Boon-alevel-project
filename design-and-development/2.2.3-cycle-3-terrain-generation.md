...
| 3    | Wait                 | A ball should drop onto the terrain and interact with it accordingly                 | As expected                                                                                     |           |
| 4    | Drag mouse on screen | Camera should function the same as it did in cycle 2                                 | As expected                                                                                     |           |
| 5    | Inspect the new game | Game features that were functioning in cycle 2 should still be working in this cycle | There were issues with the lighting such as placement of source and how shadows work in ThreeJS |           |
